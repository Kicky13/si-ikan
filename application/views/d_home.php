...
<!-- #SIDEMENU-->
<?php $this->load->view('topbar/d_navbar'); ?>
    ...
    <div class="view-wrapper">
        ...
        <div class="topbar-wrapper">
            ...
            <div class="topbar-wrapper-mobile-nav"><a class="topbar-togger js-minibar-toggler" href="#"><i class="icon ion-ios-arrow-back hidden-md-down"></i><i class="icon ion-navicon-round hidden-lg-up"></i></a><a class="topbar-togger pull-xs-right hidden-lg-up js-nav-toggler" href="#"><i class="icon ion-android-person"></i></a>
                ...
                --><a class="topbar-wrapper-logo demo-logo" href="index-2.html">Distributor</a>
            </div>
            <!-- END NAV FOR MOBILE-->
                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <h4 class="page-header-title">Dashboard<b>Distributor</b></h4>
...
<script type="text/javascript">
    ...
    var BarChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels:["<?php echo $supplier['konsumen'][0]['nama_konsumen']; ?>", "<?php echo $supplier['konsumen'][1]['nama_konsumen']; ?>", "<?php echo $supplier['konsumen'][2]['nama_konsumen']; ?>", "<?php echo $supplier['konsumen'][3]['nama_konsumen']; ?>", "<?php echo $supplier['konsumen'][4]['nama_konsumen']; ?>", "<?php echo $supplier['konsumen'][5]['nama_konsumen']; ?>"],
            datasets: [{
                label: "Nila",
                ...
                pointBorderWidth: 1,
                data: [
                    <?php echo $supplier['nilai'][0][0][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][0][1][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][0][2][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][0][3][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][0][4][0]['jumlah']; ?>]
            }, {
                label: "Gurami",
                ...
                pointBorderWidth: 1,
                data: [
                    <?php echo $supplier['nilai'][1][0][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][1][1][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][1][2][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][1][3][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][1][4][0]['jumlah']; ?>]
            }, {
                label: "Patin",
                ...
                pointBorderWidth: 1,
                data: [
                    <?php echo $supplier['nilai'][2][0][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][2][1][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][2][2][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][2][3][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][2][4][0]['jumlah']; ?>]
            }, {
                label: "Lele",
                ...
                pointBorderWidth: 1,
                data: [
                    <?php echo $supplier['nilai'][3][0][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][3][1][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][3][2][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][3][3][0]['jumlah']; ?>,
                    <?php echo $supplier['nilai'][3][4][0]['jumlah']; ?>]
            }]
        }
    });
</script>
