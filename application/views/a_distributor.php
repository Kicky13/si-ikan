                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <div class="display-6">Tabel<b>Data Supplier</b></div>
                            <p class="small text-muted">Tabel data Supplier ikan</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="pull-xs-right" role="toolbar"><a class="btn btn-icon icon-only"></a><a class="btn btn-icon icon-only"></a><a class="btn btn-info" href="<?php echo base_url('index.php/konsumen/form'); ?>" >Tambah Supplier</a></div>
                </div>
            </div>
        </div>
        <!-- END PAGE HEADER-->
                            ...
                            <div class="panel-body">
                                <table class="table" data-plugin="DataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row->jumlah_distributor; ?></td>
                                        <td>
                                            <?php echo '<a href="'.base_url('index.php/supplier/getFormedit/'.$row->id_supplier).'" type="button" class="btn m-b-2 btn-whatsapp"><i class="fa icon fa-pencil-square-o"></i></a>'; ?>
                                            <?php echo '<button onclick="hapus(\'Anda Yakin ingin menghapus supplier ini ?\', \' '.base_url('index.php/supplier/deleteSupplier/'.$row->id_supplier).'\')" class="btn m-b-2 btn-youtube" type="button"><i class="fa icon fa-trash"></i></button>'; ?>
                                        </td>
                                        <?php } ?>
                                    </tr>
                                    </tbody>
        ...
        <script>
            function hapus(pesan,url) {
                swal({
                        ...
                        confirmButtonText: "Ya, Hapus supplier ini",
                    ...
                    function(isConfirm){
                        if (isConfirm) {
                            ...
                            swal("Dibatalkan", "Supplier tidak dihapus :)", "error");
                        }
                    });
            }
        </script>
