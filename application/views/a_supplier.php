    ...
    <div class="view-wrapper">
        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="pull-xs-right" role="toolbar"><a class="btn btn-icon icon-only"></a><a class="btn btn-icon icon-only"></a><a class="btn btn-info" href="<?php echo base_url('index.php/supplier/form'); ?>" >Tambah Supplier</a></div>
                </div>
            </div>
        </div>
        <!-- END PAGE HEADER-->
                            ...
                            <div class="panel-body">
                                <table class="table" data-plugin="DataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo '<a href="'.base_url('index.php/supplier/formEdit/'.$row->id_supplier).'" type="button" class="btn m-b-2 btn-whatsapp"><i class="fa icon fa-pencil-square-o"></i></a>'; ?>
