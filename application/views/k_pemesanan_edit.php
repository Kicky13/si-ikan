...
<head>
    ...
    * layout-drawer (changed the var on top)
    ...
    -->
    <script type="text/javascript" src="<?php echo base_url().'assets/'; ?>jquery-1.3.2.js"></script>
                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <div class="display-6">Form Pemesanan</div>
                            <div class="small text-muted">Masukkan pemesanan sesuai dengan yang dibutuhkan</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        <div class="panel-heading">
                            <h6 class="panel-title">FORM PEMESANAN</h6>
                        </div>
                        <div class="panel-body">
                            <form autocomplete="off" action="<?php echo base_url('index.php/pemesanan/editPemesanan'); ?>" method="post">
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Nama Supplier</h4>
                                            <input class="form-control" type="text" value="<?php echo $detail['nama_supplier']; ?>" disabled>
                                            <input type="hidden" value="<?php echo $detail['id_supplier']; ?>" name="supplier">
                                            <input type="hidden" value="<?php echo $detail['id_pemesanan']; ?>" name="id">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Nama Ikan</h4>
                                        <select class="form-control" data-plugin="select2" name="ikan" id="ikan" required>
                                            <?php foreach ($ikan as $item) { ?>
                                                <option value="<?php echo $item['id_ikan']; ?>" <?php echo ($item['id_ikan'] == $detail['id_ikan']) ? "selected":""; ?>><?php echo $item['nama_ikan']; ?></option>';
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Tanggal Pemesanan</h4>
                                        <div class="datepicker-wrapper open">
                                            <input class="form-control" type="text" data-plugin="datepicker" name="tanggalpemesanan" value="<?php echo $detail['tanggal_pesan']; ?>" placeholder="dd/mm/yyyy">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select class="form-control" data-plugin="select2" name="usia" id="usia" required>
                                            <option value=""><?php echo $detail['ket_usia']; ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select class="form-control" data-plugin="select2" name="ukuran" id="ukuran" required>
                                            <option value=""><?php echo $detail['ket_ukuran_ikan']; ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Kondisi</h4>
                                        <select class="form-control" data-plugin="select2" name="kondisi" required>
                                            <?php foreach ($kondisi as $kondisi){ ?>
                                                <option value="<?php echo $kondisi->id_kondisi_ikan; ?>" <?php echo ($kondisi->id_kondisi_ikan == $detail['id_kondisi_ikan']) ? "selected":""; ?>><?php echo $kondisi->ket_kondisi_ikan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select class="form-control" data-plugin="select2" name="warna" required>
                                            <?php foreach ($warna as $warna){ ?>
                                                <option value="<?php echo $warna->id_warna_ikan; ?>" <?php echo ($warna->id_warna_ikan == $detail['id_warna_ikan']) ? "selected":""; ?>><?php echo $warna->ket_warna_ikan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Jumlah</h4>
                                        <input class="form-control" type="text" data-plugin="TouchSpin" value="<?php echo $detail['jumlah']; ?>" name="jumlah">
                                    </div>
                                </div>
