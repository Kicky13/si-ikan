                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            ...
                            <p class="small text-muted">Tabel data konsumen ikan</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="pull-xs-right" role="toolbar"><a class="btn btn-icon icon-only"></a><a class="btn btn-icon icon-only"></a><a class="btn btn-info" href="<?php echo base_url('index.php/konsumen/form'); ?>" >Tambah Konsumen</a></div>
                </div>
            </div>
        </div>
        <!-- END PAGE HEADER-->
                            ...
                            <div class="panel-body">
                                <table class="table" data-plugin="DataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo '<a href="'.base_url('index.php/konsumen/getFormedit/'.$row->id_konsumen).'" type="button" class="btn m-b-2 btn-whatsapp"><i class="fa icon fa-pencil-square-o"></i></a>'; ?>
                                            <?php echo '<button onclick="hapus(\'Anda Yakin ingin menghapus konsumen ini ?\', \' '.base_url('index.php/konsumen/deleteKonsumen/'.$row->id_konsumen).'\')" class="btn m-b-2 btn-youtube" type="button"><i class="fa icon fa-trash"></i></button>'; ?>
                                        </td>
                                        <?php } ?>
                                    </tr>
                                    </tbody>
