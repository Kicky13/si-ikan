                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <div class="display-6">Tabel <b>Aspek Kualitas Ikan</b></div>
                            <p class="small text-muted">Tabel data aspek kualitas ikan</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="pull-xs-right" role="toolbar"><a class="btn btn-icon icon-only"></a><a class="btn btn-icon icon-only"></a><a class="btn btn-info" href="<?php echo base_url('index.php/kualitas/formAddkualitas'); ?>">Tambah Aspek</a></div>
                </div>
            </div>
        </div>
        <!-- END PAGE HEADER-->
                                ...
                                <table class="table" data-plugin="DataTable">
                                    ...
                                    <?php foreach ($data as $row){ ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row->ket_kondisi_ikan; ?></td>
                                            <td><?php echo $row->ket_warna_ikan; ?></td>
                                            <td>
                                                <?php echo '<a href="'.base_url('index.php/kualitas/formEdit/'.$row->id_aspek).'" type="button" class="btn m-b-2 btn-whatsapp"><i class="fa icon fa-pencil-square-o"></i></a>'; ?>
                                                <?php echo '<button onclick="hapus(\'Anda Yakin ingin menghapus aspek ini ?\', \' '.base_url('index.php/kualitas/deleteAspek/'.$row->id_aspek).'\')" class="btn m-b-2 btn-youtube" type="button"><i class="fa icon fa-trash"></i></button>'; ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
        ...
        <script>
            function hapus(pesan,url) {
                swal({
                        ...
                        confirmButtonText: "Ya, Hapus Aspek ini",
                    ...
                    function(isConfirm){
                        if (isConfirm) {
                            ...
                            swal("Dibatalkan", "Aspek tidak dihapus :)", "error");
                        }
                    });
            }
        </script>
