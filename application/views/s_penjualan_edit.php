                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <div class="display-6">Form Rekap Penjualan</div>
                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form autocomplete="off" action="<?php echo base_url('index.php/rekap/editPemesanan'); ?>" method="post">
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Distributor</h4>
                                        <input type="hidden" value="<?php echo $detail['id_pemesanan']; ?>" name="id">
                                        <select class="form-control" data-plugin="select2" name="distributor" required>
                                            <option value="">--Pilih Distributor--</option>
                                            <?php foreach ($distributor as $distributor){ ?>
                                                <option value="<?php echo $distributor->id_distributor; ?>" <?php echo ($distributor->id_distributor == $detail['id_distributor']) ? "selected":""; ?>><?php echo $distributor->nama_distributor; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
