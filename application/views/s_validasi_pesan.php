                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <div class="display-6">Tabel <b>Pemesanan</b></div>
                            <p class="small text-muted">Tabel data pemesanan ikan</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                                ...
                                <table class="table" data-plugin="DataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if ($row->hasil == ""){
                                                echo '<a href="'.base_url('index.php/pemesanan/analisaIkan/'.$row->id_pemesanan.'/'.$row->id_ikan).'" class="btn m-b-2 btn-behance" type="button"><i class="fa icon fa-calculator"></i></a>';
                                            } else {
                                                echo '<a href="'.base_url('index.php/pemesanan/validasi/'.$row->id_pemesanan).'" class="btn m-b-2 btn-whatsapp" type="button"><i class="fa icon fa-check"></i></a>';
                                                echo '<a href="'.base_url('index.php/pemesanan/tolak/'.$row->id_pemesanan).'" class="btn m-b-2 btn-youtube" type="button"><i class="fa icon fa-times"></i></a>';
                                            }
                                            ?>
                                        </td>
                                    <?php } ?>
...
<div id="preload">
    <ul class="loading">
        ...
        <!--MODAL-->
        <div class="modal fade-scale side" id="po-side" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Offers ear in two a future hologram the weary outfits out have errors wanted bale the met quite to that based texts. The as future in some queen's and that this slight text, everyday. Past, and felt this unprofitable didn't rivalry.</p>
                    </div>
