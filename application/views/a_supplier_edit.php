                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form autocomplete="off" action="<?php echo base_url('index.php/supplier/editSupplier/'.$data[0]['id_supplier']); ?>" method="post">
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Username</h4>
                                        <input class="form-control" type="text" name="username" value="<?php echo $data[0]['username']; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Password</h4>
                                        <input class="form-control" type="password" name="password" value="<?php echo $data[0]['password']; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Nama Supplier</h4>
                                        <input class="form-control" type="text" name="nama" value="<?php echo $data[0]['nama_supplier']; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Alamat Supplier</h4>
                                        <input class="form-control" type="text" name="alamat" value="<?php echo $data[0]['alamat_supplier']; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Jumlah Distributor</h4>
                                        <input class="form-control" type="text" data-plugin="TouchSpin" value="<?php echo $data[0]['jumlah_distributor']; ?>" name="distributor">
                                    </div>
                                </div>
