                            ...
                            <div class="panel-body">
                                <table class="table" data-plugin="DataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a <?php echo ($row->id_status_pemesanan > 4) ? "hidden" : ""; ?> href="<?php echo base_url('index.php/rekap/getFormedit/'.$row->id_pemesanan); ?>" type="button" class="btn m-b-2 btn-whatsapp"><i class="fa icon fa-pencil-square-o"></i></a>
                                            <?php echo '<button onclick="hapus(\'Anda Yakin ingin menghapus pemesanan ini ?\', \' '.base_url('index.php/rekap/deletePesan/'.$row->id_pemesanan).'/rekap\')" class="btn m-b-2 btn-youtube" type="button"><i class="fa icon fa-times"></i></button>'; ?>
                                        </td>
                                        <?php } ?>
                                    </tr>
                                    </tbody>
