                                ...
                                <table class="table" data-plugin="DataTable">
                                    ...
                                    <?php foreach ($data as $row){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if($row->id_status_pemesanan < 6) {
                                                    echo '<a href="'.base_url('index.php/pemesanan/validasiKirim/'.$row->id_pemesanan).'" class="btn m-b-2 btn-whatsapp" type="button"><i class="fa icon fa-check"></i></a>';
                                                } else {
                                                    echo '';
                                                }
                                                ?>
                ...
                swal({
                    ...
                    function(isConfirm){
                        if (isConfirm) {
                            ...
                            swal("Cancelled", "Your imaginary file is cancelled :)", "error");
                        }
                    });
            }
