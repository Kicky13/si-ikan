                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <div class="display-6">Form Pendaftaran</div>
                            <div class="small text-muted">Masukkan data konsumen</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form autocomplete="off" action="<?php echo base_url('index.php/konsumen/editKonsumen/'.$detail[0]['id_konsumen']); ?>" method="post">
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Username</h4>
                                        <input required class="form-control" type="text" name="username" value="<?php echo $detail[0]['username']; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Password</h4>
                                        <input required class="form-control" type="password" name="password" value="<?php echo $detail[0]['password']; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Nama</h4>
                                        <input required class="form-control" type="text" name="nama" value="<?php echo $detail[0]['nama_konsumen']; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Alamat</h4>
                                        <input required class="form-control" type="text" name="alamat" value="<?php echo $detail[0]['alamat_konsumen']; ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Jenis Konsumen</h4>
                                        <select required class="form-control" data-plugin="select2" name="jenis">
                                            <?php foreach ($data as $data){ ?>
                                                <option value="<?php echo $data->id_jenis_konsumen; ?>" <?php echo ($data->id_jenis_konsumen == $detail[0]['id_jenis_konsumen']) ? "selected":""; ?>><?php echo $data->jenis_konsumen; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
