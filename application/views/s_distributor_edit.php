                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form autocomplete="off" action="<?php echo base_url('index.php/distributor/editDistributor/'.$data[0]['id_distributor']); ?>" method="post">
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Username</h4>
                                        <input class="form-control" type="text" name="username" value="<?php echo $data[0]['username']; ?>" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Password</h4>
                                        <input class="form-control" type="password" name="password" value="<?php echo $data[0]['password']; ?>" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Nama Distributor</h4>
                                        <input class="form-control" type="text" name="nama" value="<?php echo $data[0]['nama_distributor']; ?>" required>
                                    </div>
                                </div>
