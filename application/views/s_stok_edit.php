                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <div class="display-6">Form Stok Ikan</div>
                            <div class="small text-muted">Masukkan data stok ikan</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        <div class="panel-heading">
                            <h6 class="panel-title">FORM STOK</h6>
                        </div>
                        <div class="panel-body">
                            <form autocomplete="off" action="<?php echo base_url('index.php/stok/editStok'); ?>" method="post">
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select required class="form-control" data-plugin="select2" name="ikan" id="ikan">
                                            <?php foreach ($ikan as $ikan){ ?>
                                                <option value="<?php echo $ikan->id_ikan; ?>" <?php echo ($ikan->id_ikan == $data[0]['id_ikan']) ? "selected":""; ?>><?php echo $ikan->nama_ikan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select required class="form-control" data-plugin="select2" name="usia" id="usia">
                                            <option value=""><?php echo $data[0]['ket_usia']; ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Ukuran (Kg)</h4>
                                        <select required class="form-control" data-plugin="select2" name="ukuran" id="ukuran">
                                            <option value=""><?php echo $data[0]['ket_ukuran_ikan']; ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select required class="form-control" data-plugin="select2" name="warna">
                                            <?php foreach ($warna as $warna){ ?>
                                                <option value="<?php echo $warna->id_warna_ikan; ?>" <?php echo ($warna->id_warna_ikan == $data[0]['id_warna_ikan']) ? "selected":""; ?>><?php echo $warna->ket_warna_ikan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select required class="form-control" data-plugin="select2" name="kondisi">
                                            <?php foreach ($kondisi as $kondisi){ ?>
                                                <option value="<?php echo $kondisi->id_kondisi_ikan; ?>" <?php echo ($kondisi->id_kondisi_ikan == $data[0]['id_kondisi_ikan']) ? "selected":""; ?>><?php echo $kondisi->ket_kondisi_ikan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Persediaan</h4>
                                        <input required class="form-control" type="text" data-plugin="TouchSpin" value="<?php echo $data[0]['persediaan']; ?>" name="stok">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Harga</h4>
                                        <input required class="form-control" type="text" value="<?php echo $data[0]['harga']; ?>" name="harga">
                                    </div>
                                </div>
