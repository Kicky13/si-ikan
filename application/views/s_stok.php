                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <div class="display-6">Tabel<b>Stok</b></div>
                            <p class="small text-muted">Tabel data stok ikan</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="pull-xs-right" role="toolbar"><a class="btn btn-icon icon-only"></a><a class="btn btn-icon icon-only"></a><a class="btn btn-info" href="<?php echo base_url('index.php/stok/formAdd'); ?>">Tambah Stok</a></div>
                </div>
            </div>
        </div>
        <!-- END PAGE HEADER-->
                                ...
                                <table class="table" data-plugin="DataTable">
                                    ...
                                    <?php foreach ($data as $row){ ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo '<a href="'.base_url('index.php/stok/formEdit/'.$row->id_stok).'" type="button" class="btn m-b-2 btn-whatsapp"><i class="fa icon fa-pencil-square-o"></i></a>'; ?>
                                                <?php echo '<button onclick="hapus(\'Anda Yakin ingin menghapus Stok ini ?\', \' '.base_url('index.php/stok/deleteStok/'.$row->id_stok).'\')" class="btn m-b-2 btn-youtube" type="button"><i class="fa icon fa-trash"></i></button>'; ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
        ...
        <script>
            function hapus(pesan,url) {
                swal({
                        ...
                        confirmButtonText: "Ya, Hapus Stok ini",
                    ...
                    function(isConfirm){
                        if (isConfirm) {
                            ...
                            swal("Dibatalkan", "Stok tidak dihapus :)", "error");
                        }
                    });
            }
        </script>
