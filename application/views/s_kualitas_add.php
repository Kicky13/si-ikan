                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form autocomplete="off" action="<?php echo base_url('index.php/kualitas/addKualitas'); ?>" method="post">
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select required class="form-control" data-plugin="select2" name="jenis">
                                            ...
                                            <?php foreach ($jenis as $jenis){ ?>
                                                <option value="<?php echo $jenis->id_jenis_ikan; ?>"><?php echo $jenis->jenis_ikan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
