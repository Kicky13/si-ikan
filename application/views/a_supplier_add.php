                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form autocomplete="off" action="<?php echo base_url('index.php/supplier/addSupplier'); ?>" method="post">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input class="form-control" type="text" data-plugin="TouchSpin" value="1" name="distributor">
                                    </div>
                                </div>
