                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form autocomplete="off" action="<?php echo base_url('index.php/konsumen/addKonsumen'); ?>" method="post">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select class="form-control" data-plugin="select2" name="jenis">
                                            <?php foreach ($data as $data){ ?>
                                                <option value="<?php echo $data->id_jenis_konsumen; ?>"><?php echo $data->jenis_konsumen; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
