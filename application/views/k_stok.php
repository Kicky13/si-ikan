                ...
                <div class="col-md-4">
                    <div class="media">
                        <div class="media-body">
                            <div class="display-6">Stok<b>Ikan</b></div>
                            <p class="small text-muted">Tabel Stok Ikan</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="pull-xs-right" role="toolbar"><a class="btn btn-icon icon-only"></a><a class="btn btn-icon icon-only"></a><a class="btn btn-info" href="<?php echo base_url('index.php/pemesanan/getForm/'.$detail[0]->id_supplier); ?>" >Pesan</a></div>
                </div>
            </div>
        </div>
        <!-- END PAGE HEADER-->
                            ...
                            <div class="panel-body">
                                <table class="table" data-plugin="DataTable">
                                    ...
                                    <?php foreach ($data as $row){ ?>
                                        <tr>
                                            <td><?php echo $row->nama_ikan; ?></>
                                            <td><?php echo $row->jstok; ?></td>
