                ...
                <div class="col-xs-12 col-sm-12 js-grid js-sizer">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form id="tambahPesan" autocomplete="off" action="<?php echo base_url('index.php/pemesanan/addPemesanan'); ?>" method="post">
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        <h4 class="demo-sub-title">Nama Supplier</h4>
                                        <?php foreach ($supplier as $supplier){ ?>
                                            <input class="form-control" type="text" value="<?php echo $supplier->nama_supplier; ?>" disabled>
                                            <input type="hidden" value="<?php echo $supplier->id_supplier; ?>" name="supplier" id="supplier">
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select class="form-control" data-plugin="select2" name="ikan" id="ikan" required>
                                            ...
                                            <?php foreach ($ikan as $item) {
                                                echo '<option value="'.$item['id_ikan'].'">'.$item['nama_ikan'].'</option>';
                                            }?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="datepicker-wrapper open">
                                            <input class="form-control" type="text" data-plugin="datepicker" name="tanggalpemesanan" placeholder="dd/mm/yyyy" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select class="form-control" data-plugin="select2" name="kondisi" required>
                                            ...
                                            <?php foreach ($kondisi as $kondisi){ ?>
                                                <option value="<?php echo $kondisi->id_kondisi_ikan; ?>"><?php echo $kondisi->ket_kondisi_ikan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <select class="form-control" data-plugin="select2" name="warna" required>
                                            ...
                                            <?php foreach ($warna as $warna){ ?>
                                                <option value="<?php echo $warna->id_warna_ikan; ?>"><?php echo $warna->ket_warna_ikan; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input class="form-control" type="text" data-plugin="TouchSpin" value="1" name="jumlah" id="jumlah" required>
                                        <span id="span"></span>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#jumlah').keyup(function () {
            ...
            $.ajax({
                type        :   'POST',
                url         :   '<?php echo base_url('index.php/pemesanan/cekStok'); ?>',
                data        : {
                    "jumlah" : jumlah,
                    "supplier" : supplier,
                    "ikan" : ikan
                ...
                console.log(data);
                $('#span').html(data);
                if (data=='Jumlah yang dipesan melebihi batas Stok'){
